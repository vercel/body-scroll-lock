...
var setOverflowHidden = function setOverflowHidden(options) {
  ...
  if (previousBodyPaddingRight === undefined) {
    ...
    if (_reserveScrollBarGap && scrollBarGap > 0) {
      var computedBodyPaddingRight = parseInt(window.getComputedStyle(window.top.document.body).getPropertyValue('padding-right'), 10);
...
var restorePositionSetting = function restorePositionSetting() {
  if (previousBodyPosition !== undefined) {
    ...
    var y = -parseInt(window.top.document.body.style.top, 10);
    var x = -parseInt(window.top.document.body.style.left, 10);
